...
#ifndef WIIMOTE_MSGS__MSG__DETAIL__TIMED_SWITCH__TYPE_SUPPORT_H_
#define WIIMOTE_MSGS__MSG__DETAIL__TIMED_SWITCH__TYPE_SUPPORT_H_
...
#endif  // WIIMOTE_MSGS__MSG__DETAIL__TIMED_SWITCH__TYPE_SUPPORT_H_
