...
static const _IrSourceInfo_type_support_symbol_names_t _IrSourceInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wiimote_msgs, msg, IrSourceInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, wiimote_msgs, msg, IrSourceInfo)),
  }
};
...
{
  return &::wiimote_msgs::msg::rosidl_typesupport_cpp::IrSourceInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, wiimote_msgs, msg, IrSourceInfo)() {
  return get_message_type_support_handle<wiimote_msgs::msg::IrSourceInfo>();
}
